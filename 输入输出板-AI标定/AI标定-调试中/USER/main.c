...
{
		//
		t[0]=Get_ATOD(channel_AI1);delay_ms(5);//必须加延时且延时时间大于等于2ms
		t[1]=Get_ATOD(channel_AI2);delay_ms(5);
		t[2]=Get_ATOD(channel_AI3);delay_ms(5);
		t[3]=Get_ATOD(channel_AI4);delay_ms(5);
}
